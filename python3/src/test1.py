...
from problem1 import itshotitscold


if __name__ == '__main__':
    # Initialize argument parser
    args = th.create_parser('Test the itshotitscold solution.').parse_args()
    ...
    if args.test_dir is not None:
        ...
        for test_file in test_files:
            # Get the test data
            temperatures = th.get_int_list_from_file(test_file)
            ...
            actual = itshotitscold(temperatures)
